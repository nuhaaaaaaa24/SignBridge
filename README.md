...
* The validations for profile update and contact form needs to be added
* Current password field needs to be added to the update form

## Notes
Routes need to be modified - current navigation is clunky
Conditions for 0.3 = functional webcam and model integration
